...
var $author$project$View$dropdownConfig = { highlightedAttrs: [ $gren_lang$browser$Html$Attributes$class('suggestion-item-highlighted') ], liAttrs: [ $gren_lang$browser$Html$Attributes$class('suggestion-item') ], mouseDownMsg: $author$project$Msg$ClickedSuggestion, mouseEnterMsg: $author$project$Msg$MouseEnterSuggestion, ulAttrs: [ $gren_lang$browser$Html$Attributes$id('suggestion-dropdown'), $gren_lang$browser$Html$Attributes$class('suggestion-dropdown') ] };
...
var $author$project$View$render_search_text_input = function(model) {
	var inputClass = model.dropdownState.isOpen ? 'dropdown-open' : '';
	return A2($gren_lang$browser$Html$input, [ $gren_lang$browser$Html$Attributes$type_('text'), $gren_lang$browser$Html$Attributes$id('search-term'), $gren_lang$browser$Html$Attributes$placeholder('e.g., Thailand'), $gren_lang$browser$Html$Attributes$value(model.searchText), $gren_lang$browser$Html$Events$onInput($author$project$Msg$UpdateSearchText), $author$project$OnKeyDown$onKeyDown($author$project$Msg$KeyDownSearchText), $gren_lang$browser$Html$Attributes$class(inputClass), $gren_lang$browser$Html$Events$onBlur($author$project$Msg$SearchInputBlurred), $gren_lang$browser$Html$Events$onFocus($author$project$Msg$SearchInputFocused) ], [  ]);
};
...
var $author$project$View$view = function(model) {
	return { body: [ $author$project$View$render_content(model) ], title: 'AutoDropdown Example' };
};
